	...
	for model in pdb :
		for chain in model :
			...
			for residue in chain: 	
				...
				#
				# PHI angle
				if "phi" in residue.xtra and residue.xtra["phi"] > -5.:
				...
				#
				# PSI angle
				if "psi" in residue.xtra and residue.xtra["psi"] > -5.:
				...
				#
				#chis 
				if "chi" in residue.xtra :
					for i in range (1,5) :
						x = "x%d" % i
						if  x in residue.xtra["chi"] and residue.xtra["chi"][x] > -5.:
